...
Notation "'\(' x , y '\)'" := (ordered_pair x y)(x at level 99, y at level 99).
Notation "'\(' x , y , .. , z '\)'" := (ordered_pair (..(ordered_pair x y) ..) z)(x at level 99, y at level 99, z at level 99).
...
Definition binary_relation := {s : set | forall e, e in s -> (exists a b, e = \(a, b\))}.
Print binary_relation.

Example RR : forall R : binary_relation, \({{}}, {{}}\) in R -> \({{}}, {{}}\) in R.
End SetTheory.